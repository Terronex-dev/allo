...
async function readEngram(data, options = {}) {
    ...
    if (header.security.encrypted) {
        ...
        payloadBytes = await decryptPayload(payloadBytes, options.password, header.security.salt, header.security.nonce);
    }
    // Decode payload
...
async function decryptPayload(ciphertext, password, salt, nonce) {
    // Derive key
