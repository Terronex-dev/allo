...
async function writeEngram(file, options = {}) {
    ...
    const header = {
        ...
        embedding: file.header.embedding ?? types_1.DEFAULT_EMBEDDING_CONFIG,
        security,
        modified: Date.now()
    };
