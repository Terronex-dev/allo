...
export type LinkType = 'related' | 'references' | 'contradicts' | 'supersedes' | 'elaborates' | 'summarizes' | 'causes' | 'follows' | 'supports' | 'derived_from' | 'similar_to';
...
export declare const DEFAULT_HNSW_CONFIG: Partial<HNSWConfig>;
